package org.btrplace.scheduler.ucc15.capping;
...
public class mVM {
    ...
    public void cappingTest() throws SchedulerException {
        ...
        // Add a continuous 9kW power budget
       cstrs.add(new PowerBudget(9000));
        ...
        try {
            ...
            try {
                FileWriter file = new FileWriter(path + "mVM.json");
            ...
            energyView.plotConsumption(p, path + "mVM_theory.csv");
